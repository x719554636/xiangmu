...
<div class="main w1210 bc mt10">
    ...
    <div class="content fl ml10">
        <div class="address_hd">
            ...
            <dl>
                <dt><?= $model->id ?>&nbsp;&nbsp;<?= $model->name ?>&nbsp;&nbsp;<?= $model->four ?>&nbsp;&nbsp;<?= $model->distri ?>
                    &nbsp;&nbsp; <?= $model->xian ?>&nbsp;&nbsp;<?= $model->tel ?>
                </dt>
                <dd>
                    <a href="<?=\yii\helpers\Url::to(['address/edit','id'=>$model->id])?>">修改</a>
                    <a href="<?=\yii\helpers\Url::to(['address/del','id'=>$model->id])?>">删除</a>
                    <a href="">设为默认地址</a>
                </dd>
            </dl>
           <?php endforeach;?>
            ...
            <form action="" name="address_form" method="post">
                <ul>
                    <li>
                        ...
                        <input type="text" name="name" class="txt" value="<?= $model_one->name?>"/>
                    </li>
                    <li>
                        <label for=""><span>*</span>所在地区：</label>

                        <select id="cmbProvince" name="four"  value="<?= $model_one->four?>"></select>
                        <select id="cmbCity" name="distri"  value="<?= $model_one->distri?>"></select>
                        <select id="cmbArea" name="xian"  value="<?= $model_one->xian?>"></select>
                    ...
                    <li>
                        ...
                        <input type="text" name="addr" class="txt address" value="<?= $model_one->addr?>" />
                    </li>
                    <li>
                        <label for=""><span>*</span>手机号码：</label>
                        <input type="text" name="tel" class="txt" value="<?= $model_one->tel?>"/>
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
                        <input type="checkbox" name="aefault"  value="1" class="check" <?= $model_one->tel?>/>设为默认地址
                    </li>
                    <li>
                        <label for="">&nbsp;</label>
