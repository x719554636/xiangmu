...
<div class="mycart w990 mt10 bc">
    ...
    <table>
        ...
        <tr data-id="<?=$model->id?>">
            <td class="col1"><a href=""><img src="<?='http://admin.yii.com'.$model->logo?>" alt="" /></a>  <strong><a href=""><?=$model->name?></a></strong></td>
            ...
            <td class="col6"  id="delete"><a href="">删除</a></td>
        </tr>
        <?php endforeach;?>
        </tbody>
        <tfoot>
    ...
    <div class="cart_btn w990 bc mt10">
        ...
        <a href="<?= \yii\helpers\Url::to(['header/order'])?>" class="checkout">结 算</a>
    </div>
</div>
<!-- 主体部分 end -->
