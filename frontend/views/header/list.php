        ...
        <div class="goodslist mt10">
            <ul>
                <?php foreach ($models as $model):?>
                    <li>
                        <dl>
                            <dt><a href="<?= \yii\helpers\Url::to(['header/goods','id'=>$model->id])?>"><img src="http://admin.yii.com<?= $model->logo?>" alt="" /></a></dt>
                            <dd><a href="<?= \yii\helpers\Url::to(['header/goods','id'=>$model->id])?>"><?= $model->name ?></a></dt>
                            <dd><strong><?=$model->market_price?></strong></dt>
