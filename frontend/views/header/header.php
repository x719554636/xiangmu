        ...
        <div class="topnav_right fr">
            <ul>
                ...
                <?php if(!\Yii::$app->user->isGuest){ ?>
                    <li>您好，欢迎来到京西！[<a href="<?= \yii\helpers\Url::to(['user/logout']) ?>">注銷</a>] </li>
                <?php  } ?>
                <li class="line">|</li>
                <li>我的订单</li>
                <li class="line">|</li>
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl">
            ...
            <div class="cat_bd">
                ...
                <div class="cat item1">
                    <h3><a href="<?= \yii\helpers\Url::to(['header/list','id'=>$model->id])?>"><?= $model->name?></a> <b></b></h3>
                    ...
                    <div class="cat_detail">
                        ...
                        <dl>
                            <dt><a href="<?= \yii\helpers\Url::to(['header/list','id'=>$Category->id])?>"><?= $Category->name; ?></a></dt>

                            <dd>
                                <?php foreach ($Category->category as $item) :?>
                                <a href="<?= \yii\helpers\Url::to(['header/list','id'=>$item->id])?>">
                                    <?=  $item->name; ?>
                                </a>
                                <?php endforeach; ?>
                            </dd>
