    ...
    <div class="goods_content fl mt10 ml10">
        ...
        <div class="summary">
                ...
                <div class="smallpic">
                    ...
                    <div class="smallpic_wrap">
                        ...
                        <ul>
                            ...
                            <li class="cur">
                                <a class="" href="<?= 'admin.yii.com'.$png->path;?>" rel="{gallery: 'gal1', smallimage: '<?= 'admin.yii.com'.$png->path;?>',largeimage: 'images/preview_l1.jpg'}"><img src="<?= 'admin.yii.com'.$png->path;?>"></a>
                            </li>
            ...
            <div class="goodsinfo fl ml10">
                ...
                <form action="<?= \yii\helpers\Url::to(['header/notice'])?>" method="get" class="choose">
                    <ul>
